...
categories:
  - package
photo:
  url: https://www.flickr.com/photos/far/18906469928
  author: Farhad Pocha
---



It is with great excitement that we announce the release of [rlang 0.4.0](https://rlang.r-lib.org) on CRAN. rlang is a toolkit for working with core R and Tidyverse features, and hosts the tidy evaluation framework.

...
by automatically running `devtools::document()`.`build_site()` has also gained
a `new_process` argument. When `new_process` is set to `TRUE` (as it is by
default), pkgdown will be run in a separate process to improve reproducibility.

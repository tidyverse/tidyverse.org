...
As described in our [pre-release post](https://www.tidyverse.org/articles/2018/05/ggplot2-2-3-0/), we decided 
that it’s worth breaking a small amount of existing code in the interests of 
improving future code. The changes should affect relatively little user code, but have required developers to make changes. A separate post will address developer-facing changes in further detail, however, common errors and ways to work around them can be found 
...
ggplot2 now works on R 3.1 onwards, and uses the [vdiffr](https://github.com/lionel-/vdiffr) package for visual testing. This helps us make only deliberate breaking changes.
...
<img src="/articles/2018-07-ggplot2-3-0-0_files/figure-html/label-both-1.png" width="1500" />

## New features

Below we describe just some of the new features and functionality added. For a full account of these improvements, please see [NEWS](https://github.com/tidyverse/ggplot2/blob/master/NEWS.md).

### sf

Thanks to the help of Edzer Pebesma and the r-spatial team, ggplot2 now has full support for simple features through 
...
<img src="/articles/2018-07-ggplot2-3-0-0_files/figure-html/sf-1.png" width="1500" />
...
<img src="/articles/2018-07-ggplot2-3-0-0_files/figure-html/tag-1.png" width="1500" />

### Layers: geoms, stats, and position adjustments

The new `position_dodge2()` allows you to arrange the horizontal position of plots with variable widths (i.e. bars and rectangles, in addition to box plots). By default, `position_dodge2()` preserves the width of each element.
...
<img src="/articles/2018-07-ggplot2-3-0-0_files/figure-html/dodge2-single-1.png" width="1500" />

You can choose to preserve the total width by setting the `preserve` argument to `"total"`. Thank you to Kara Woo for all of her work on this.
...
<img src="/articles/2018-07-ggplot2-3-0-0_files/figure-html/dodge2-total-1.png" width="1500" />

### Scales and guides

The new `scale_alpha()` function can be used to but can be used to visually down-weight less important observations.
...
<img src="/articles/2018-07-ggplot2-3-0-0_files/figure-html/scale-alpha-1.png" width="1500" />
...
<img src="/articles/2018-07-ggplot2-3-0-0_files/figure-html/viridis-1.png" width="1500" />
...
<img src="/articles/2018-07-ggplot2-3-0-0_files/figure-html/viridis-c-1.png" width="1500" />
...
<img src="/articles/2018-07-ggplot2-3-0-0_files/figure-html/guide-colorbar-1.png" width="1500" />
...
<img src="/articles/2018-07-ggplot2-3-0-0_files/figure-html/nsa-independent-scale-1.png" width="1500" />

We only touch on a few of the new features in ggplot2 — there are many many more. If there's a feature you particularly like, and you write a blog post about, please share it with us using [this form](https://goo.gl/forms/elGvrlIXgTZVtCap1), and we'll include in a round up post in a month's time.

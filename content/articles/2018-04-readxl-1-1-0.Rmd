...
I am very thankful to the maintainers of the embedded libraries, especially the recent work on libxls by David Hoerl and Evan Miller. readxl includes a great deal of compiled code, from disparate sources, and Jim Hester is a fantastic troubleshooter. David Hood delivered some delightful Clippy photos (featured here), in response to an [absurd Twitter request](https://twitter.com/JennyBryan/status/987415546596503552).

...
Modelling functions will occassionally create a data frame like this, but since the model frame can't be coerced a tibble method, `augment()` will fail:
...
## 1 -1.45   0.538 0.0268   0.559   0.483 -0.532  0.622 0.00798 1.10   
## 2  0.436 -0.188 0.927    1.22    0.559 -0.290  0.833 0.497   2.23   
## 3 -1.35   0.139 1.60     1.00    0.441  0.594  0.519 0.123   0.706  
## 4  0.429  0.424 0.601    0.526   0.335  0.0753 0.300 0.861   0.00310
## 5  0.803  0.770 0.254    0.101   0.521  0.153  0.726 0.815   0.200  

...
The new `calc()` function offers a cleaner, and better-documented syntax for 
...
This is particularly nice for more complex calculations, as `calc()` only needs 
to be specified once; e.g. `aes(y = calc(count / max(count)))` rather than 

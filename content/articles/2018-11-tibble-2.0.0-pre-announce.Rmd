...
- `new_tibble()` is very fast and does very little checking itself.
...
Packages that are in the business of making tibbles may even want to expose the `.name_repair` argument and pass it through to `tibble()` or `as_tibble()`.

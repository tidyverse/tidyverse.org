...
minor, helping authors conform to the tidyverse style guide, and requesting
reviews from Hadley for bigger changes.
...
fixed not only the original issue, but three other issues as well.
...
notice only very minor changes as a result of this project, but internally we've
really cleaned up the code, reduced duplication, and documented a number of
internal functions to make them easier to work with in the future.

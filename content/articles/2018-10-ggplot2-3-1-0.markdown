...
Because the British and American spellings of "color" are now fully equivalent throughout the entire ggplot2 code base, the following four examples all produce the same plot.

...
*  `str_squish()`, which removes whitespace from the left and right sides of strings, and converts multiple spaces or space-like characters from the _middle_ of strings into a single space.

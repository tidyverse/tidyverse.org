...
#> 1 dat[dat$x > 500, ]           279µs    329µs    299µs   1.15ms     3038.     416KB    96  1087      358ms
#> 2 dat[which(dat$x > 500), ]    214µs    256µs    233µs    1.1ms     3900.     357KB    89  1271      326ms
#> 3 subset(dat, x > 500)         346µs    416µs    378µs   1.38ms     2406.     548KB    88   746      310ms
```
...
#> 1 dat[dat$x > 500, ]         1.30  1.28   1.29  1.05      1.26      1.16  1.09  1.46       1.15
#> 2 dat[which(dat$x > 500), ]  1     1      1     1         1.62      1     1.01  1.70       1.05
#> 3 subset(dat, x > 500)       1.62  1.62   1.63  1.26      1         1.53  1     1          1
```

...
The next planned release of *dplyr* will be a feature release: Romain, author of the data frame backend for *dplyr* and coauthor of the *Rcpp* package, has joined the team and hit the ground running.  He has implemented many of the features described in this blog post, many more are already available in the development version.  Welcome (back), Romain, looking forward to a great time!

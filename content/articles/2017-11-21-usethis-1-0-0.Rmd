...
Most functions have a `scope` argument which can be either "user" or "project". This lets you control the scope of your changes: either to the current project, or to all projects opened by the current user (the default).

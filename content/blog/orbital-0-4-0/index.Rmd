...
Having set up a data base we could have used `orbital_sql()` to show what the SQL query would have looked like. For quick testing, the output isn't immediately ready to be pasted over in its own file due to the `<SQL>` fragments around in the output.

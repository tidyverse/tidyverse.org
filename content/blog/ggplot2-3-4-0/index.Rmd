...
On the topic of `after_stat()` the values and computations happening inside of this now works on the un-transformed variables rather than the transformed ones. This is a bit esoteric and only applies to aesthetics that have had a scale transformation applied to them, so you may never notice.

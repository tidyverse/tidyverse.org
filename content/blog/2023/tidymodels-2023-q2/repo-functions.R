...
# gh::gh("/orgs/tidymodels/repos", .limit = 10000) |>
#   purrr::map_chr("name") |>
#   sort()

tm_pkgs <-c(
  "agua", "applicable", "baguette", "bonsai", "broom", "brulee", "butcher",
  "censored", "corrr", "desirability2", "dials", "discrim", "embed", "finetune",
  "hardhat", "modeldata", "modeldatatoo", "modeldb", "multilevelmod", "parsnip",
  "plsmod", "poissonreg", "probably", "recipes", "rsample", "rules",
  "shinymodels", "spatialsample", "stacks", "textrecipes", "themis",
  "tidyclust", "tidymodels", "tidyposterior", "tidypredict", "tune","usemodels",

...
While this is the 1.0.0 release of forcats, this version number is mainly a signal that we think forcats is stable, and don't anticipated any major changes in the future.
...
I've left the (Other) category as a bar at the end, but by rearranging the order of `fct_infreq()` and `fct_lump_min()` I could cause it to also sort in frequency order.

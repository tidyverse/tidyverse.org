...
Around the time when I was really getting into ggplot extensions, Gina Reynolds had started organising a meeting for people who build ggplot2 extensions.
...
It may not seem like much of a contribution, but in retrospect, answering issues helps triaging them: it separate those issues that need additional changes in ggplot2 from those that do not.

...
That makes it possible to take basically the same dplyr code and execute it in radically different ways by using different backends.
...
Generally, you'll want to group the data before partitioning because that ensures that all observations in one group end up on the same worker.

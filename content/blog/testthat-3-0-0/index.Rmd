...
I'll also give a quick round up of the other major changes, but you might want to look at the [release notes](%7B%20github_release%20%7D) for the full details.
...
-   We have revamped the non-interactive reporter to do a better job of displaying skipped tests, and have written a vignette, `vignette("skipping", package = "testthat")`, describing best practices (including how to test your own skip functions).

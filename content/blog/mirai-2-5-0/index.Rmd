...
→ `daemons()` has been redesigned to be more ergonomic.
...
→ New `info()` function provides a more succinct alternative to `status()` for reporting key statistics. This is optimized and available for programmatic use.

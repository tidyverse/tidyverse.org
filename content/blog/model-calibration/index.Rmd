...
```{r, fig.alt = "Calibration plot with 10 bins, created with the cal_plot_breaks() function"}
segment_logistic %>% 
...
```{r, fig.alt = "Calibration plot with 5 bins, created with the cal_plot_breaks() function"}
segment_logistic %>% 

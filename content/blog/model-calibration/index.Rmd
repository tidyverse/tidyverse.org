...
Notice the ribbon plot in gray that envelops the plot line. These are the confidence
intervals. This is also an argument that can be adjusted via `conf_level`. The
default is 0.9. 

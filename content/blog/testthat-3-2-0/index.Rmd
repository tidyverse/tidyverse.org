...
The default fails if there is any error/warning/message, but you can optionally supply either the `message` or `class` arguments to confirm that a specific error/warning/message is no longer present.
...
Mocking allows you to temporarily `complicated()` with something simpler, allowing you to test the rest of the function.

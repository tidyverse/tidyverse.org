...
We refer to these objects as _model specifications_, and each are composed of three main components:
...
Aside from the consistency in syntax, another advantage of the parsnip package is that it's extensible; anyone (including you!) can write a parsnip _extension package_ that tightly integrates with our packages out-of-the-box. We maintain a few of these packages ourselves, such as:

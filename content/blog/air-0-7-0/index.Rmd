...
Autobracing is particularly important for if statements.
...
Air still allows single line if statements if they look to be used for their *return value* rather than for their *side effect*.

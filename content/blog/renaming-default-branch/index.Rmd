...
* Advertise new functions in version 2.1.2. of the usethis package that help
  with the above.
...
The recently released 2.1.2 version of usethis has some new functions to support changes in the default branch.
...
The recent usethis release (v2.1.2) tries much harder to alert the user if the default branch name changes and to provide an easy way to sync up.

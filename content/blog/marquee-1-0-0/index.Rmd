...
This also means that your ggplots can contain additional ggplots (or other graphics) anywhere you are allowed to place text (using `geom_marquee()` and `element_marquee()`).

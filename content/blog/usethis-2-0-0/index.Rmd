...
If you decide to clone Matt Lincoln's clipr package, while perusing its issues, you can provide the current browser URL to `create_from_github()`, i.e. you don't have to trim both ends to isolate `mdlincoln/clipr`.
...
The new default in this situation is HTTPS, because we think HTTPS is a better choice, for most users and projects (rationale is above).

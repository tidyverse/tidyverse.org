...
We strive for excellence in open-source data analysis across all programming languages. To facilitate this, **we are hiring an open-source developer** specializing in data analysis and modeling tools. Deep learning models already have extensive support in Python, so our focus is on the analysis and modeling of _tabular data_. 

Our primary goal is to develop packages that enhance the existing capabilities of packages such as scikit-learn. We are hiring a software developer to focus on creating new programming APIs to help users facilitate their data analysis and modeling tasks. Note that the current position doesn't involve building or publishing models created here; _this is a pure package developer role_. 

There are numerous ways that individuals can contribute to improving the ecosystem. We have a lot of ideas, but we also want to know what our new hire believes is most important. Open-source software developers at Posit often have a broader role than just writing and testing code. We are often the folks defining what is deemed important and prioritizing our work. Additionally, we frequently undertake tasks that are not typically considered part of developer relations, such as reaching out to the community, creating additional technical content, speaking at conferences, and teaching workshops. 

If you are a driven and independent developer, you might be interested in this position. You'll have a lot of agency here and in an environment that encourages quality. Our developers tend to feel a personal stake in our work and want it to be as good as it can be. 

A sample of potential projects that have been on our mind:
...
Posit is a great environment for package developers. We're a completely remote team, flexible in terms of how and when we work, and we do a good job of minimizing administrative overhead for engineers.

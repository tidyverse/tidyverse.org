...
S7 is a new object-oriented programming (OOP) system designed to superceed both S3 and S4.
...
-   `convert()` now implements a default method for transforming a parent class instance into a subclass.

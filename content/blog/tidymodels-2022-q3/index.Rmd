...
With h2o and tidymodels, you should probably **use h2o's parallelization**. Using multiple approaches _can_ work but only for some technologies. It's still pretty complicated and we will work more on un-complicating it. 

...
```{r}
daily <- mutate(daily, type = c("A", "B", "B", "A"))
daily
```
...
```{r}
readouts2 <- slice(readouts, seq_len(n()), n()) 
readouts2
```
...
complete(daily, day, fill = list(value = 0))
```

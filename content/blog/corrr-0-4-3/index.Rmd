...
We can create a `cor_df` object containing the pairwise correlations between numerical columns of the `palmerpenguins::penguins` data set to see that the first column is now named "term":  

...
Then we'll finish off by diving into the many small, but useful, functions that we've accumulated in the three and half years since the last release.
...
We've tried to keep these small and we don't believe they'll affect much code in the wild (only affected \~20 of the \~1600 packages that use stringr).
...
We've also spend a bunch of time reviewing the documentation, particularly the topic titles and descriptions.

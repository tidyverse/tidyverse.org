...
All models can be fitted through a formula interface. For example, when the engine allows for stratification variables, these can be specified by using a `strata()` term to the formula, as in the survival package.

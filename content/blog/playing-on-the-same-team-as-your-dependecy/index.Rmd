...
This blog post goes into detail as to what your promise entails.
...
dependency check where all packages on CRAN that depend on the
submitted package are checked against the new version. If any regressions
...
which now no longer exists. As you might imagine, this can lead to some

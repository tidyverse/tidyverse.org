...
From a pedagogical perspective, tidymodels has three main advantages: the framework provides similar interfaces to models, model outputs are straightforward to interact with for learners who already know how to wrangle and visualize data stored in tibbles, and it helps users avoid common machine learning pitfalls.

...
The other nice part about `mark()` is that it will check that each approach gives the same output, so that you don't mistakenly compare apples and oranges.

...
We use a function because the same code is reused throughout the article.
...
The comparison is done in a fresh R session where dplyr is attached but duckplyr is not.

...
We're very chuffed to announce the release of [duckplyr](https://duckplyr.tidyverse.org) 1.1.0.
...
For your existing dbplyr code, the new `as_tbl()` function allows you to convert a duckplyr tibble to a dbplyr lazy table.
...
Another way to leverage the potential of DuckDB is the new `dd$` qualifier.

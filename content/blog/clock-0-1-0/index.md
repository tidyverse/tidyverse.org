...
-   Implements a [high level API](https://r-lib.github.io/clock/reference/index.html#section-high-level-api) for Date and POSIXct classes that lets you get productive quickly without having to learn the details of the underlying classes.

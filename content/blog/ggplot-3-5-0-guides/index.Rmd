...
This blog post will outline improvements to ggplot2's guide system, which underwent a large rewrite.
...
The justification of legends is controllable by using the `legend.justifcation.{position}` theme setting.
...
Previously, it was also used space legend keys apart; that is no longer the case.
...
They way guides typically carry information about a scale's breaks and labels is the `key` variable.

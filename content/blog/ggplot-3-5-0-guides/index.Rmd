...
Guides (axes and legends) are visual representations of scales and allow observers to translate graphical properties of a plot into information.
...
The theta guides adhere to the `{setting}.theta` styling, and radial guides to the `{setting}.r` styling.

```{r theta_axis}
#| fig.alt: >
#|  A scatterplot in horseshoe-shaped polar coordinates. The guides
...
ggplot(mpg, aes(displ, hwy)) +
  geom_point() +
  coord_radial(start = 0.25 * pi, end = 1.75 * pi, inner.radius = 0.3) +
  guides(
  ...
  theme(
    axis.line.theta = element_line(colour = "blue"),
    axis.line.r     = element_line(colour = "red")
  )
```

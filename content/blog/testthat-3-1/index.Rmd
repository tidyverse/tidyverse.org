...
We made this change because it makes `expect_message()` and `expect_warning()` more consistent with `expect_error()`, while make it easier to inspect both the value and the mesasge/warning.
